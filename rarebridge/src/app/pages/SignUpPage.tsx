  ...
  return (
    <section className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E7E2CE]/40">
        <h1 className="font-black text-2xl text-[#112250] mb-4">Create an account</h1>
        <p className="text-sm text-[#3B507D] mb-6">Get started with RareBridge to save favorites and participate in community discussions.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <button type="submit" className="px-5 py-2 rounded-xl bg-[#112250] text-white font-semibold">Create account</button>
            <button type="button" onClick={() => onNav("signin")} className="px-4 py-2 rounded-xl border border-[#BEB7A7] text-[#112250]">Sign in</button>
